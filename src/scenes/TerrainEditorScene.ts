...
export class TerrainEditorScene extends Phaser.Scene {
  private maps: MapOption[] = [
    { id: 'ishetar_new', name: 'Ishetar Town', file: 'map_ishetar_new' },
    { id: 'south_gate', name: 'South Gate', file: 'map_south_gate', isBattle: true },
    { id: 'hunting_paths', name: 'Hunting Paths', file: 'map_hunting_paths', isBattle: true },
    { id: 'quetzi_shrine', name: 'Quetzi Shrine', file: 'map_quetzi_shrine', isBattle: true },
    { id: 'hellhound_cave', name: 'Hellhound Cave', file: 'map_hellhound_cave', isBattle: true },
    { id: 'maple_tree', name: 'Old Maple Tree', file: 'map_maple_tree' },
    { id: 'travel', name: 'Travel Map', file: 'map_travel' },
  ];

  private enemyTypes: string[] = ['imp', 'lemure', 'spined_devil', 'ogre', 'hellhound'];
  ...
  preload(): void {
    // Load all maps
    this.load.image('map_ishetar_new', 'assets/maps/ishetar_new.jpg');
  ...
  private loadMap(index: number): void {
    ...
    // Load map image (scaled to 50% to match game rendering)
